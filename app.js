...
function trainNeuron() {
  ...
  document.getElementById('lossPanel').style.display     = '';

  drawNeuron(neuronModel);
  drawLoss(neuronModel.lossHistory);
  neuronTrained = true;
  updateStatus();
...
function resetNeuronVisuals() {
  ...
  document.getElementById('neuronIdle').style.display    = '';
